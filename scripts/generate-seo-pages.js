...
const cases = [
  {
    slug: 'beauty-space-concept', image: '/images/projects/beauty-y2k-v2.webp', demo: 'https://vitthegrandfather.github.io/salon/', repo: 'https://github.com/vitthegrandfather/salon',
  ...
  {
    slug: 'tattoo-studio-concept', image: '/images/projects/tattoo-y2k-v2.webp', demo: 'https://vitthegrandfather.github.io/tattoosalondemo/', repo: 'https://github.com/vitthegrandfather/tattoosalondemo',
  ...
  {
    slug: 'forma17-concept', image: '/images/editorial/witer-motion-portrait.webp', demo: 'https://vitthegrandfather.github.io/FORMA17/', repo: 'https://github.com/vitthegrandfather/FORMA17',
    uk: { title: 'FORMA17 — монохромний portfolio concept', meta: 'Кейс WITER: авторський концепт монохромного портфоліо FORMA17 для вигаданої незалежної креативної студії.', intro: 'Вигадана креативна студія як поле для радикальної типографіки, редакційної композиції та motion.', label: 'Studio / concept', detailTitle: 'Характер без акцентного кольору.', detail: 'FORMA17 — self-initiated концепт без реального клієнта чи комерційного брифу. Завданням було перевірити, чи може сувора чорно-біла система залишатися емоційною, різноманітною й переконливою на всій довжині портфоліо.', cards: [['ROLE','Concept · Art direction · UX/UI'],['BUILD','Next.js · React · TypeScript'],['FOCUS','Editorial system · Motion · Video']] },
    en: { title: 'FORMA17 — Monochrome Portfolio Concept', meta: 'WITER case study: a self-initiated monochrome portfolio concept for the fictional independent creative studio FORMA17.', intro: 'A fictional creative studio used as a field for radical typography, editorial composition and motion.', label: 'Studio / concept', detailTitle: 'Character without an accent colour.', detail: 'FORMA17 is a self-initiated concept created without a real client or commercial brief. The aim was to test whether a strict black-and-white system could remain emotional, varied and convincing throughout a complete studio portfolio.', cards: [['ROLE','Concept · Art direction · UX/UI'],['BUILD','Next.js · React · TypeScript'],['FOCUS','Editorial system · Motion · Video']] }
  }
];
