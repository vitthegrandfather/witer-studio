...
function shell({ lang, kind, slug, content, type, image = '/og-image-2026.png', extraSchema = {} }) {
  const isEn = lang === 'en';
  const home = isEn ? '/en/' : '/';
