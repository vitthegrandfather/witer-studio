...
(function initTechModal() {
    ...
    const predictions = [
        ...
        "Котик бачить великий успіх на горизонті",
        ...
        "Кіт відчуває, що попереду перемога",
        ...
        "Котик бачить щастя поруч з тобою",
        ...
        "Кіт радить частіше посміхатись",
        ...
        "Котик бачить подорож у твоєму майбутньому",
        ...
        "Котик бачить удачу на твоєму шляху",
        ...
        "Котик бажає тобі теплих обіймів",
        ...
        "Котик бажає тобі яскравих фарб",
        ...
        "Кіт бажає тобі гарного настрою",
