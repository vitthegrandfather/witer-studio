...
(function initTechModal() {
    ...
    // Cat Easter Egg
    const predictionsUk = [
        "Сьогодні на тебе чекає приємний сюрприз",
        "Завтра буде ідеальний день для нових починань",
        "Незабаром отримаєш гарні новини",
        "Хтось зараз думає про тебе з теплотою",
        "Твоя усмішка зробить чийсь день кращим",
        "Неочікуваний гість принесе радість",
        "Сьогодні вдалий день для подорожі",
        "Твоя мрія наближається до здійснення",
        "Вітерець бачить великий успіх на горизонті",
        "Знайдеш те, що давно шукав",
        "Сьогодні варто довіритися інтуїції",
        "Незабаром зустрінеш цікаву людину",
        "Твій наступний крок змінить багато чого",
        "Сьогодні вечір буде особливим",
        "Довгоочікувана новина вже в дорозі",
        "Вітерець радить зробити перерву",
        "Твої зусилля незабаром принесуть плоди",
        "Чекай приємного знайомства",
        "Сьогодні все складеться якнайкраще",
        "Твоя креативність сьогодні на висоті",
        "Несподіваний комплімент підніме настрій",
        "Вітерець відчуває, що попереду перемога",
        "Сьогодні варто спробувати щось нове",
        "Твоя наполегливість вразить оточуючих",
        "Незабаром отримаєш те, на що заслуговуєш",
        "Сьогодні твій день — насолоджуйся",
        "Вітерець бажає тобі натхнення",
        "Попереду багато яскравих моментів",
        "Твоя ідея має великий потенціал",
        "Сьогодні варто сказати «дякую»",
        "Хтось готує для тебе сюрприз",
        "Твоя впевненість відкриє нові двері",
        "Незабаром все стане на свої місця",
        "Сьогодні обов'язково посміхнись",
        "Вітерець бачить щастя поруч з тобою",
        "Твоя доброта повернеться сторицею",
        "Попереду романтичний вечір",
        "Сьогодні вдалий день для шопінгу",
        "Незабаром отримаєш несподіваний подарунок",
        "Твоя харизма сьогодні на максимумі",
        "Сьогодні варто ризикнути",
        "Вітерець радить частіше посміхатись",
        "Твій оптимізм надихає оточуючих",
        "Незабаром відбудеться довгоочікувана подія",
        "Сьогодні тобі пощастить у дрібницях",
        "Твоя енергія зараз на висоті",
        "Попереду цікава розмова",
        "Сьогодні варто довіритись другу",
        "Вітерець бачить подорож у твоєму майбутньому",
        "Незабаром здійсниться бажання",
        "Твоя працелюбність буде винагороджена",
        "Сьогодні вечір ідеальний для відпочинку",
        "Хтось хоче подякувати тобі",
        "Твоя інтуїція сьогодні бездоганна",
        "Незабаром почнеться щось нове та прекрасне",
        "Сьогодні варто подумати про себе",
        "Вітерець бажає тобі легкого дня",
        "Твій сміх — це найкращі ліки",
        "Попереду незабутні враження",
        "Сьогодні тобі посміхнеться доля",
        "Незабаром отримаєш довгоочікувану відповідь",
        "Твоя чарівність сьогодні неперевершена",
        "Сьогодні вдалий день для творчості",
        "Вітерець відчуває позитивні зміни",
        "Твоя сміливість відкриє нові можливості",
        "Незабаром все буде так, як ти хочеш",
        "Сьогодні варто скуштувати щось смачне",
        "Попереду весела пригода",
        "Твоя щедрість повернеться добром",
        "Сьогодні тобі зроблять комплімент",
        "Вітерець бачить удачу на твоєму шляху",
        "Незабаром отримаєш гарну звістку",
        "Твоя мудрість вразить оточуючих",
        "Сьогодні ідеальний день для кохання",
        "Попереду яскраві емоції",
        "Твоя посмішка освітить чийсь день",
        "Сьогодні варто вірити в диво",
        "Вітерець бажає тобі теплих обіймів",
        "Незабаром станеться те, про що ти мрієш",
        "Твоя душевність — твоя сила",
        "Сьогодні все буде гаразд",
        "Попереду зустріч з давнім другом",
        "Твоя відкритість принесе нові знайомства",
        "Сьогодні вдалий день для прогулянки",
        "Вітерець радить більше відпочивати",
        "Незабаром отримаєш несподівану пропозицію",
        "Твій оптимізм — твоя зброя",
        "Сьогодні варто поділитися теплом",
        "Попереду круті зміни",
        "Твоя енергія зараз неймовірна",
        "Сьогодні тобі все вдасться",
        "Вітерець бачить світле майбутнє",
        "Незабаром зустрінеш свою долю",
        "Твоя доброта змінює світ",
        "Сьогодні вечір буде казковим",
        "Попереду багато приводів для радості",
        "Твоя віра в себе надихає",
        "Сьогодні варто мріяти ще більше",
        "Вітерець бажає тобі затишку",
        "Незабаром все складеться ідеально",
        "Твоя унікальність — твій козир",
        "Сьогодні тобі пощастить у коханні",
        "Попереду незабутня ніч",
        "Твоя сила духу вражає",
        "Сьогодні варто сказати правду",
        "Вітерець відчуває велику любов",
        "Незабаром отримаєш довгоочікуваний результат",
        "Твоя щирість підкорює серця",
        "Сьогодні все буде на твою користь",
        "Попереду море позитиву",
        "Твоя хоробрість буде винагороджена",
        "Сьогодні ідеальний день для початку",
        "Вітерець бажає тобі яскравих фарб",
        "Незабаром трапиться диво",
        "Твоя ніжність зігріває душу",
        "Сьогодні варто насолоджуватись моментом",
        "Попереду чекає сюрприз від долі",
        "Твій погляд на світ — надихаючий",
        "Сьогодні все буде по-твоєму",
        "Вітерець бачить удачу в усьому",
        "Незабаром отримаєш найкращий подарунок — увагу",
        "Твоя любов до життя заразлива",
        "Сьогодні вдалий день для зізнань",
        "Попереду багато теплих моментів",
        "Твоя душа сяє яскравіше за зірки",
        "Сьогодні варто обійняти когось",
        "Вітерець бажає тобі гарного настрою",
        "Незабаром життя подарує тобі найкраще",
        "Твоя дитяча посмішка — безцінна",
        "Сьогодні все буде чудово"
    ];

    const predictionsEn = [
        "A pleasant surprise awaits you today",
        "Tomorrow will be the perfect day for new beginnings",
        "Good news is coming your way soon",
        "Someone is thinking of you with warmth right now",
        "Your smile will make someone's day better",
        "An unexpected guest will bring joy",
        "Today is a great day for a journey",
        "Your dream is getting closer to coming true",
        "Breezy sees great success on the horizon",
        "You'll find what you've been looking for",
        "Today is a good day to trust your intuition",
        "You'll meet an interesting person soon",
        "Your next step will change a lot",
        "Tonight will be special",
        "Long-awaited news is already on its way",
        "Breezy suggests taking a break",
        "Your efforts will bear fruit soon",
        "Expect a pleasant acquaintance",
        "Everything will work out perfectly today",
        "Your creativity is at its peak today",
        "An unexpected compliment will lift your mood",
        "Breezy feels victory ahead",
        "Today is a good day to try something new",
        "Your persistence will impress those around you",
        "You'll receive what you deserve soon",
        "Today is your day — enjoy it",
        "Breezy wishes you inspiration",
        "Many bright moments lie ahead",
        "Your idea has great potential",
        "Today is a good day to say thank you",
        "Someone is preparing a surprise for you",
        "Your confidence will open new doors",
        "Everything will fall into place soon",
        "Make sure to smile today",
        "Breezy sees happiness near you",
        "Your kindness will come back tenfold",
        "A romantic evening awaits",
        "Today is a great day for shopping",
        "You'll receive an unexpected gift soon",
        "Your charisma is at its max today",
        "Today is a good day to take a risk",
        "Breezy suggests smiling more often",
        "Your optimism inspires those around you",
        "A long-awaited event will happen soon",
        "You'll get lucky with small things today",
        "Your energy is at its peak right now",
        "An interesting conversation awaits",
        "Today is a good day to trust a friend",
        "Breezy sees a journey in your future",
        "Your wish will come true soon",
        "Your hard work will be rewarded",
        "Tonight is perfect for rest",
        "Someone wants to thank you",
        "Your intuition is flawless today",
        "Something new and wonderful will begin soon",
        "Today is a good day to think about yourself",
        "Breezy wishes you an easy day",
        "Your laughter is the best medicine",
        "Unforgettable experiences await",
        "Fortune will smile on you today",
        "You'll get the long-awaited answer soon",
        "Your charm is unmatched today",
        "Today is a great day for creativity",
        "Breezy feels positive changes",
        "Your courage will open new opportunities",
        "Everything will be as you want it soon",
        "Today is a good day to try something delicious",
        "A fun adventure awaits",
        "Your generosity will return with kindness",
        "Someone will give you a compliment today",
        "Breezy sees luck on your path",
        "Good tidings are coming your way soon",
        "Your wisdom will impress those around you",
        "Today is the perfect day for love",
        "Bright emotions lie ahead",
        "Your smile will brighten someone's day",
        "Today is a good day to believe in miracles",
        "Breezy wishes you warm hugs",
        "What you've been dreaming of will happen soon",
        "Your warmth is your strength",
        "Everything will be okay today",
        "A meeting with an old friend awaits",
        "Your openness will bring new connections",
        "Today is a great day for a walk",
        "Breezy suggests resting more",
        "An unexpected offer is coming your way",
        "Your optimism is your weapon",
        "Today is a good day to share warmth",
        "Big changes are ahead",
        "Your energy is incredible right now",
        "You'll succeed at everything today",
        "Breezy sees a bright future",
        "You'll meet your soulmate soon",
        "Your kindness changes the world",
        "Tonight will be magical",
        "Many reasons for joy lie ahead",
        "Your faith in yourself inspires",
        "Today is a good day to dream even bigger",
        "Breezy wishes you comfort",
        "Everything will work out perfectly soon",
        "Your uniqueness is your ace",
        "Love will be on your side today",
        "An unforgettable night awaits",
        "Your strength of spirit is impressive",
        "Today is a good day to tell the truth",
        "Breezy feels great love",
        "You'll get the long-awaited result soon",
        "Your sincerity wins hearts",
        "Everything will work in your favor today",
        "A sea of positivity lies ahead",
        "Your bravery will be rewarded",
        "Today is the perfect day to start",
        "Breezy wishes you vibrant colors",
        "A miracle will happen soon",
        "Your tenderness warms the soul",
        "Today is a good day to enjoy the moment",
        "A surprise from destiny awaits",
        "Your outlook on life is inspiring",
        "Everything will go your way today",
        "Breezy sees luck in everything",
        "You'll receive the best gift — attention",
        "Your love for life is contagious",
        "Today is a great day for confessions",
        "Many warm moments lie ahead",
        "Your soul shines brighter than the stars",
        "Today is a good day to give someone a hug",
        "Breezy wishes you a great mood",
        "Life will give you the best soon",
        "Your childlike smile is priceless",
        "Everything will be wonderful today"
    ];

    function getPrediction() {
        const list = currentLang === 'en' ? predictionsEn : predictionsUk;
    ...
    catBody.addEventListener('click', () => {
        ...
        // Show prediction based on current language
        catSpeech.textContent = getPrediction();
